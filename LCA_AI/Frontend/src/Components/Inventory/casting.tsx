...
export default function Casting({
  ...
  const [materialInputQuantity_tons, setMaterialInputQuantity_tons] =
    useState("");
  const [operatingTemperature_C, setOperatingTemperature_C] = useState("");
  const [energyConsumption_kWh_per_ton, setEnergyConsumption_kWh_per_ton] =
    useState("");
  const [energySource, setEnergySource] = useState("");
  const [moldMaterial, setMoldMaterial] = useState("");
  const [coolingMethod, setCoolingMethod] = useState("");
  const [waterConsumption_liters_per_ton, setWaterConsumption_liters_per_ton] =
    useState("");
  ...
  const [finalProductYield_percent, setFinalProductYield_percent] =
    useState("");
  const [materialLoss_percent, setMaterialLoss_percent] = useState("");
  const [wasteGenerated_kg_per_ton, setWasteGenerated_kg_per_ton] =
    useState("");
  ...
  const submitCastingData = async () => {
    ...
    if (
      ...
      const errorMsg =
        "Please fill in all required fields: Casting Process Type, Material Input Quantity, and Operating Temperature";
      setError(errorMsg);
    ...
    try {
      const castingPayload = {
        ...
        energyConsumption_kWh_per_ton: energyConsumption_kWh_per_ton
          ? Number(energyConsumption_kWh_per_ton)
          : undefined,
        energySource: energySource || undefined,
        moldMaterial: moldMaterial || undefined,
        coolingMethod: coolingMethod || undefined,
        waterConsumption_liters_per_ton: waterConsumption_liters_per_ton
          ? Number(waterConsumption_liters_per_ton)
          : undefined,
        emissions: emissions || undefined,
        defectRate_percent: defectRate_percent
          ? Number(defectRate_percent)
          : undefined,
        scrapRecycled_percent: scrapRecycled_percent
          ? Number(scrapRecycled_percent)
          : undefined,
        scrapQualityLevel: scrapQualityLevel || undefined,
        packagingType: packagingType || undefined,
        finalProductYield_percent: finalProductYield_percent
          ? Number(finalProductYield_percent)
          : undefined,
        materialLoss_percent: materialLoss_percent
          ? Number(materialLoss_percent)
          : undefined,
        wasteGenerated_kg_per_ton: wasteGenerated_kg_per_ton
          ? Number(wasteGenerated_kg_per_ton)
          : undefined,
        operatingCost_per_ton: operatingCost_per_ton
          ? Number(operatingCost_per_ton)
          : undefined,
      };
      ...
      const errorMsg =
        error.response?.data?.message || "Failed to submit casting data";
      setError(errorMsg);
      if (onError) onError(errorMsg);
    } finally {
      setIsLoading(false);
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="text-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Casting Data Submitted Successfully!
              </h2>
              <p className="text-gray-600">
                Your casting process data has been recorded.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-900 font-mono">
                    {castingResponse.castingData?._id || "N/A"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-900">
                    {castingResponse.castingData?.castingProcessType || "N/A"}
                  </p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">
                  ...
                  <p className="text-gray-900">
                    {castingResponse.castingData?.materialInputQuantity_tons ||
                      "N/A"}{" "}
                    tons
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-900">
                    {castingResponse.castingData?.operatingTemperature_C ||
                      "N/A"}
                    °C
                  </p>
                </div>
                <div>
                  ...
                  <div className="text-gray-900">
                    {castingResponse.castingData?.moldMaterial &&
                    Array.isArray(castingResponse.castingData.moldMaterial)
                      ? castingResponse.castingData.moldMaterial.map(
                          (mold: any, index: number) => (
                            <p key={index}>
                              {mold.type}: {mold.amount_kg} kg
                            </p>
                          )
                        )
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {castingResponse.castingData?.coolingMethod || "N/A"}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="text-gray-900">
                        {Array.isArray(castingResponse.castingData.energySource)
                          ? castingResponse.castingData.energySource.map(
                  ...
                  {castingResponse.castingData.emissions && (
                    <div>
                      ...
                      <div className="text-gray-900">
                        {typeof castingResponse.castingData.emissions ===
                          "object" &&
                        castingResponse.castingData.emissions !== null ? (
                          <>
                            {castingResponse.castingData.emissions
                              .CO2_kg_per_ton && (
                              <p>
                          ...
                          <p>
                            {castingResponse.castingData.emissions || "N/A"}
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  {castingResponse.castingData.operatingCost_per_ton && (
                    <div>
                      ...
                      <p className="text-gray-900">
                        ${castingResponse.castingData.operatingCost_per_ton}/ton
                      </p>
                    </div>
                  )}
            ...
            <div className="bg-green-50 rounded-lg p-4 mb-6">
              ...
              <div className="text-sm">
                {(() => {
                  const yield_percent =
                    castingResponse.castingData?.finalProductYield_percent || 0;
                  const defectRate =
                    castingResponse.castingData?.defectRate_percent || 0;
                  const materialLoss =
                    castingResponse.castingData?.materialLoss_percent || 0;
                  ...
                  if (
                    ...
                    return (
                      <div className="flex items-center text-green-700">
                        ...
                        <span>
                          Excellent casting efficiency! High yield with minimal
                          defects and material loss.
                        </span>
                      </div>
                    );
                  } else if (
                    ...
                    return (
                      <div className="flex items-center text-yellow-700">
                        <span className="text-lg mr-2">⚡</span>
                        <span>
                          Good casting process. Consider optimizing to reduce
                          defects and material loss.
                        </span>
                      </div>
                    );
                    ...
                    return (
                      <div className="flex items-center text-orange-700">
                        ...
                        <span>
                          Casting process needs improvement. Focus on reducing
