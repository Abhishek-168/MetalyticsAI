...
export default function Refining({
  ...
  const [wasteSlagGenerated_kg_perTon, setWasteSlagGenerated_kg_perTon] =
    useState("");
  const [materialLostAsImpurity_percent, setMaterialLostAsImpurity_percent] =
    useState("");
  ...
  const submitRefiningData = async () => {
    ...
    if (!refiningType || !materialInput_tons || !outputEfficiency_percent) {
      const errorMsg =
        "Please fill in all required fields: Refining Type, Material Input, and Output Efficiency";
      setError(errorMsg);
    ...
    try {
      const refiningPayload = {
        ...
        waterConsumption_L_perTon: waterConsumption_L_perTon
          ...
          : undefined,
        chemicalsUsed_kg_perTon: chemicalsUsed_kg_perTon
          ? Number(chemicalsUsed_kg_perTon)
          : undefined,
        wasteSlagGenerated_kg_perTon: wasteSlagGenerated_kg_perTon
          ? Number(wasteSlagGenerated_kg_perTon)
          : undefined,
        materialLostAsImpurity_percent: materialLostAsImpurity_percent
          ? Number(materialLostAsImpurity_percent)
          : undefined,
        recyclingContent_percent: recyclingContent_percent
          ? Number(recyclingContent_percent)
          : undefined,
      ...
      const errorMsg =
        ...
        "Failed to submit refining data";
      setError(errorMsg);
      if (onError) onError(errorMsg);
    } finally {
      setIsLoading(false);
  ...
  return (
    <>
      <div className="flex flex-col space-y-5 text-black">
        ...
        >
          <option value="" disabled>
            Select Recycling Output Quality
          </option>
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="text-center mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                Refining Data Submitted Successfully!
              </h2>
              <p className="text-gray-600">
                Your refining process data has been recorded.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-900 font-mono">
                    {refiningResponse.refiningData?._id}
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-gray-900">
                    {refiningResponse.refiningData?.refiningType}
                  </p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">
                  ...
                  <p className="text-gray-900">
                    {refiningResponse.refiningData?.materialInput_tons} tons
                  </p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">
                  ...
                  <p className="text-gray-900">
                    {refiningResponse.refiningData?.outputEfficiency_percent}%
                  </p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">
                  ...
                  <div className="text-gray-900">
                    {refiningResponse.refiningData?.energySource &&
                    Array.isArray(refiningResponse.refiningData.energySource)
                      ? refiningResponse.refiningData.energySource.map(
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {refiningResponse.refiningData?.recyclingOutputQuality ||
                      "N/A"}
                  </p>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      <div className="text-gray-900">
                        {Array.isArray(
                          ...
                          ? refiningResponse.refiningData.chemicalsUsed_kg_perTon.map(
                              (chemical: any, index: number) => (
                                <p key={index}>
                                  {chemical.name}: {chemical.amount_kg} kg
                                </p>
                              )
                            )
            ...
            <div className="bg-green-50 rounded-lg p-4 mb-6">
              ...
              <div className="text-sm">
                {(() => {
                  ...
                  const materialLoss =
                    refiningResponse.refiningData
                      ?.materialLostAsImpurity_percent || 0;
                  ...
                  if (efficiency >= 90 && materialLoss <= 5) {
                    return (
                      <div className="flex items-center text-green-700">
                        ...
                        <span>
                          Excellent refining efficiency with minimal material
                          loss!
                        </span>
                      </div>
                    );
                    ...
                    return (
                      <div className="flex items-center text-yellow-700">
                        <span className="text-lg mr-2">⚡</span>
                        <span>
                          Good refining process. Consider optimizing to reduce
                          material loss.
                        </span>
                      </div>
                    );
                    ...
                    return (
                      <div className="flex items-center text-orange-700">
                        ...
                        <span>
                          Refining process has room for improvement in
